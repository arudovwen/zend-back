      ...
      <div>
        <div className="mb-6 flex justify-between flex-col lg:flex-row gap-y-4 items-center">
          <input
            ...
            className="text-secondary dark:text-white/80 border border-[#EAECF0] dark:border-gray-500 bg-white dark:bg-gray-800 text-sm px-[14px] py-[10px] rounded md:max-w-[280px] w-full"
          />
        </div>
